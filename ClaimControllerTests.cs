...
public class ClaimsControllerTests
{
    ...
    {
        // Clear static in-memory DB between tests
    ...
    {
        var controller = CreateControllerWithSession(); // no session values
    ...
    public async Task Approve_Reject_AreRoleRestricted()
    {
        ...
        // when unauthorized it redirects to Login
        ...
        // After approve it will redirect (to Details or ProjectCoordinator). We assert status change applied.
